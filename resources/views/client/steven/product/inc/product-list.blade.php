<div class="row mx-0 justify-center-between list_shop_page_header" style="">
    <div class="col-md-1">
        <span class="list_view_header"></span>
    </div>
    <div class="col-md-11">
        <div class="row align-items-end">
            <div class="col-md-3 header_item_number">
                <span class="list_view_header text-start">Item Number</span>
            </div>
            <div class="col-md-1 header_available_quantity">
                <span class="list_view_header">Available <br> Quantity</span>
            </div>
            <div class="col-md-2 header_price">
                <span class="list_view_header">Price</span>
            </div>
            <div class="col-md-3 header_quantity">
                <span class="list_view_header text-center">Quantity</span>
            </div>
            <div class="col-md-2">
                <span class="list_view_header"></span>
            </div>
            <div class="col-md-1 header_time">
                <span class="list_view_header text-end"></span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="product-row">
            <div class="row">
                <div class=" col-1 product-image">
                    <a class="text-decoration-none" href="{{ frontendSingleProductURL($product, $seoPath) }}">
                        <img src="{{ $product->Product_Image ?? '' }}" alt="Product Image">
                    </a>
                </div>
                <div class="col-11">
                    <div class="row custom-product-details px-2">
                        <div class="col-3 product-code">

                            <a class="fw-700 text-capitalize  text-decoration-none text-dark"
                                href="{{ frontendSingleProductURL($product, $seoPath) }}">
                                <span style="">{{ $product->productCode ?? '' }}</span>
                            </a>

                        </div>
                        <div class="col-1 product-quantity">
                            <p style="">{{ $product->ERP?->QuantityAvailable ?? '-' }}</p>
                        </div>
                        ...
                        <div class="col-3 quantity_count_custom">
                            <button class="button_minus" style=""
                            ...
                            <button class="button_plus" style=""
                        ...
                        <div class="col-1 date_details">
                            <p class="text-end" style="">
                                {{ $product->ERP?->AverageLeadTime ?? '' }}
                            </p>
                        </div>
                    </div>
                    <div class="px-2">
                        <p class="list_contant_product" style="">
                            <a class="fw-700 text-capitalize  text-decoration-none text-dark"
                                href="{{ frontendSingleProductURL($product, $seoPath) }}">
            ...
            <div class="d-flex justify-content-between" style="">
                <div class="paragraph_section_list_shop">
                    <p class="" style="">{!! $product->ship_restriction ?? null !!}</p>
                </div>
