<!-- Shop Toolbar-->
<div {!! $htmlAttributes !!}>
    <div class="d-md-flex justify-content-between align-items-center text-dark pb-4">
                ...
                <div class="mt-md-0 d-flex align-items-center gap-2">
                    ...
                    <div class="d-flex justify-content-md-end justify-content-center shop-view">
                        ...
                        <a class="list-view {{ $productView() === 'list' ? 'active' : '' }}"
                           href="{{ request()->fullUrlWithQuery(['currentPage' => $currentPage, 'view' => 'list']) }}" aria-label="List view">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="current"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
