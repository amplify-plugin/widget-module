...
@pushonce('custom-script')
    ...
    <script src="//www.cenpos.com/Plugins/porthole.min.js"></script>
    <script src="//www.cenpos.com/Plugins/jquery.simplewebpay.js"></script>
    <script src="{{ asset('js/clients/rhsparts/cenpos-payment.js') }}"></script>
    <script src="{{ asset('packages/select2/dist/js/select2.min.js') }}"></script>
    <script src="{{ asset('packages/select2/dist/js/select2.min.js') }}"></script>
@endpushonce
