@if(!empty($erp))
    <p class="customer-price py-1">
        Customer Price: <span class="text-danger">{{ (price_format($erp->Price) . "/$erp->UnitOfMeasure") }}</span>
    </p>
@endif
...
<div class="manufacture-info mb-2">
    ...
    @if(!empty($erp))
        <div class="mb-1 d-flex">
            ...
            <span class="value text-primary">{{ (price_format($erp->ListPrice). "/$erp->UnitOfMeasure") }}</span>
        </div>
        <div class="mb-1 d-flex">
