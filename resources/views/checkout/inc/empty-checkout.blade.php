        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 60 500 420">
            ...
            <g id="freepik--Character--inject-64">
                ...
                <path
                    ...
                    style="fill:#263238"></path>
                <path d="M144.91,134.16s-5.43,1.25-12.91-1.88c0,0,3.23,6.95,13.42,4.48Z" style="fill:#eb996e"></path>
                <path
                ...
                <polygon points="163.07 146.9 181.27 173.19 166.62 191.03 163.07 146.9"
                ...
                <path d="M158,429.82l-1.46,19.52s19.36,8,19.44,11.68l-38-1.47,1-30.52Z"
                    style="fill:{{ $templateBrandColor }}"></path>
                <g style="opacity:0.6000000000000001">
                    <path
            ...
            <g id="freepik--Plant--inject-64">
                ...
                <path
                    ...
                    style="fill:#263238"></path>
                <path d="M431.68,342s2.93-15.77,14.71-19.67a.53.53,0,0,1,.68.66C446.29,325.42,443.2,332.49,431.68,342Z"
                    style="fill:{{ $templateBrandColor }}"></path>
                <path
            ...
            <g id="freepik--Boxes--inject-64">
                <path
                    ...
                    style="fill:#263238"></path>
                <rect x="230.75" y="226.6" width="140.21" height="108.14" style="fill:{{ $templateBrandColor }}">
                </rect>
                ...
                <path
                    ...
                    style="fill:#263238"></path>
                <polygon points="231.07 227.79 255.87 259.23 370.96 259.23 370.96 250.76 256.65 250.76 231.07 227.79"
                    style="opacity:0.5"></polygon>
                <path d="M343.31,334.5c-.14,0-.26-18.81-.26-42s.12-42,.26-42,.27,18.8.27,42S343.46,334.5,343.31,334.5Z"
                    style="fill:#263238"></path>
                ...
                <rect x="213.89" y="334.74" width="161.21" height="124.34" style="fill:{{ $templateBrandColor }}">
                </rect>
            ...
            <g id="freepik--speech-bubble--inject-64">
                ...
                <path
                    ...
                    style="fill:{{ $templateBrandColor }}"></path>
                <path d="M69,102.44a3.58,3.58,0,1,1-2.27-4.53A3.58,3.58,0,0,1,69,102.44Z"
                    style="fill:{{ $templateBrandColor }}"></path>
            </g>
        </svg>
        <h3 class="text-center">There are no items in this cart</h3>
        <a href="{{ frontendShopURL() }}" class="btn btn-outline-primary">CONTINUE SHOPPING</a>
    </div>
</div>
