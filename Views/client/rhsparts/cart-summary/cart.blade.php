<div {!! $htmlAttributes !!}>
    ...
    <textarea style="display: none;" id="cart-single-item-custom-item-template" aria-label="Cart Products">
        <tr class="cart-summary-item">
            <td>
                <div class="product-item">
                    <a class="product-thumb" href="{product_url}">
...
@pushonce('footer-script')
    <script src="{{ asset('frontend/rhsparts/js/cart-summary.js') }}"></script>
@endpushonce
