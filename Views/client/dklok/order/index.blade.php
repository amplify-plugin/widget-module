    ...
    <div class="card">
        <div class="card-body">
            ...
            @php
                ...
                $types = request('types', ['SO']); // array for checkboxes
            ...
            <form id="searchForm" class="p-2 border bg-light" method="get" action="{{ url()->current() }}">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="position-relative">
                                <input type="text" name="startEntryDate" id="fromDate"
                                    class="form-control form-control-sm" placeholder="Select start date"
                                    value="{{ $startEntryDate }}" style="padding-right: 30px;">
                                <button type="button" class="btn btn-link position-absolute"
                                        style="right: 85px; top: 25%; transform: translateY(-50%); border: none; background: none; padding: 2px; z-index: 10; outline: none; box-shadow: none;"
                                        id="clearFromDate">
                                    <i class="fa fa-times" style="color: #6c757d; font-size: 14px;"></i>
                                </button>
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="position-relative">
                                <input type="text" name="endEntryDate" id="toDate"
                                    class="form-control form-control-sm" placeholder="Select end date"
                                    value="{{ $endEntryDate }}" style="padding-right: 30px;">
                                <button type="button" class="btn btn-link position-absolute"
                                        style="right: 85px; top: 25%; transform: translateY(-50%); border: none; background: none; padding: 2px; z-index: 10; outline: none; box-shadow: none;"
                                        id="clearToDate">
                                    <i class="fa fa-times" style="color: #6c757d; font-size: 14px;"></i>
                ...
                <div class="row">
                    <div class="col-12 text-right">
                        <button type="button" id="clearAll" class="btn btn-outline-secondary btn-sm">Clear All</button>
...
@push('custom-style')
    <style>
        ...
        #clearFromDate:focus, #clearToDate:focus,
        #clearFromDate:hover, #clearToDate:hover,
        #clearFromDate:active, #clearToDate:active {
            outline: none !important;
            box-shadow: none !important;
            border: none !important;
    ...
    <script>
        $(function() {
            ...
            $('#clearAll').click(function() {
                // Redirect to clean orders URL without any parameters
            ...
            $('#order-table').DataTable({
                ...
                columnDefs: [
                    { targets: [4, 5, 6], orderable: false }, // Warehouse, Order/Quote Value, Invoice Amount
                    { targets: -1, orderable: false }         // Last column (Action), safe even if not visible
                ]
            });
        });
    </script>
